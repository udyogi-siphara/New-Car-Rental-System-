...
<motion.div 
     ...
     className='px-6 md:px lg:px-24 xl:px-32 mt-60 text-sm text-gray-500'>
        <motion.div 
            ...
            <motion.div
                ...
                <div>
                    ...
                    '>Contact</h2>
                    <ul className='mt-3 flex flex-col gap-1.5'>
                        <li><a href="#">No : 80</a></li>
                        <li><a href="#">Galle Road, Colombo</a></li>
                        <li><a href="#">+94 112202020</a></li>
                        <li><a href="#">info@grt.com</a></li>
                    </ul>
            </div>
            </motion.div>
